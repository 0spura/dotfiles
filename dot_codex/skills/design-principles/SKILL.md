...
- Preserve keyboard, screen-reader, focus, touch, and narrow-screen operation. Use current WCAG/platform requirements when applicable.
- Make loading, empty, error, disabled, permission, and success states explicit.
- Validate important flows with representative users or an observable proxy; do not infer usability from visual polish.
