...
|---|---|---|---|
| Feature | `feat(<scope>):` | `reference/feature.md` | coder |
| Refactor | `refactor(<scope>):` | `reference/refactor.md` | coder (behavior frozen) |
...
Load tracker capabilities before creating or updating an item. Use the native identifiers and field names returned by the server; do not guess provider-specific operations. After every tracker write, read the item back and verify status, relationships, Implementation Surface, and Verification.
