...
2. Generate at least two genuinely different options. For each, state the shape, the tradeoffs, and the main risk.
...
The design is approved and saved, with clear options, a chosen path, and documented non-goals. The next step is **srs**.
