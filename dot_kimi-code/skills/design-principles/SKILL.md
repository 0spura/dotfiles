...
description: Apply practical accessibility, cognitive-load, responsive-layout, and device-specific UX defaults.
whenToUse: Use when designing user interfaces or interaction flows.
---
