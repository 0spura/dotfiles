...
description: Use before brainstorming a new product or feature area. Produces docs/product/discovery.md, the shared context that makes brainstorming grounded.
subagent: true
model: flash
---
