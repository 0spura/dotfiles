...
Include only the sections that have non-obvious decisions. Omit sections fully covered by the SRS, stack docs, or ai-memory decision summaries; a reference link is sufficient.
