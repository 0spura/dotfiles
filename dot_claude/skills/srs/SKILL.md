...
1. Read `docs/product/vision.md` if it exists. Extract the Principles and Anti-goals — these are hard filters. Any requirement that contradicts a principle must be flagged and justified before it can proceed.
